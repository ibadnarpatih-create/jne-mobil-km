...
const mapRemote = (row: TransactionRow): FuelTransactionRecord => ({
  ...
  realPayment: Number(row.real_payment), paymentDifference: Number(row.payment_difference),
...
const mapDemo = (row: TransactionRow): FuelTransactionRecord => ({
  ...
  estimatedAmount: Number(row.estimatedAmount ?? 0), realPayment: Number(row.realPayment), paymentDifference: Number(row.paymentDifference ?? 0),
